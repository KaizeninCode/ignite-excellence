const Approach = () => {
  const missionItems = [
    ...
    },
    {
      ...
      description:
        "We assist their learning about the world around us in coding, robotics, photography and film making.",
    },
    {
      title: "Arts",
      description:
    ...
    },
    {
      title: "Create",
      description:
        "We use team-based activities to build creativity, collaboration and communication skills. These incorporate literacy, numeracy and life skills.",
    },
    {
      title: "Health",
      description:
  ...
  return (
    <section className="max-w-5xl py-5 mx-auto" id="approach">
      ...
      <p className="md:text-2xl text-lg max-lg:px-4 font-light md:mt-8 mt-4">
        Our approach to the holistic development of children seeks to
